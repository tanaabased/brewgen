...
- Updated Leia examples to run on Bun with closed stdin and cover default generation, filtering, and overwrite protection. [#5](https://github.com/tanaabased/brewgen/pull/5)
...
## v1.0.0-beta.1 - [March 16, 2026](https://github.com/tanaabased/brewgen/releases/tag/v1.0.0-beta.1)
